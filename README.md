...
the acquisition arena and the named-pipe setup channel
([Local Endpoints](docs/design/local-endpoints.md)) build and are tested; capture
is not implemented yet. The SDL viewer supports macOS and
